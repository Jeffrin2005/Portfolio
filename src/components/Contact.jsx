        ...
        <div className='w-full py-16 px-4 bg-black relative'>
            ...
            <div className="text-center mb-12">
                <div className="relative inline-block group">
                    ...
                    <a href="https://drive.google.com/file/d/1txuQLeiLtPkhhPvbCRnXmw7ZPzIFaoSD/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="relative inline-flex items-center px-8 py-3 bg-black text-white border border-neon_bg rounded-xl space-x-2 hover:bg-neon_bg/10 transition-all duration-300" >
