...
const Contact = () => {
    ...
    return (
        <div className='w-full py-16 px-4 bg-[#0A0A0A] relative'>
            ...
            <div className="max-w-[90%] md:max-w-[600px] mb-12 mx-auto mt-10 bg-[#1A1A1A] p-8 rounded-xl border border-neon_bg shadow-[0_0_15px_rgba(0,212,255,0.3)]">
                <form className="space-y-6">
                    <div className="space-y-4">
                        {['Your Name', 'Your Email'].map((placeholder, index) => (
                            <input key={index} type={index === 1 ? 'email' : 'text'} placeholder={placeholder}
                                className="w-full p-3 rounded-lg bg-[#252525] text-white border border-neon_bg/50 focus:border-neon_bg focus:ring-2 focus:ring-neon_bg/50 transition duration-300" />
                        ))}
                        <textarea placeholder="Your Message" rows="4"
                            className="w-full p-3 rounded-lg bg-[#252525] text-white border border-neon_bg/50 focus:border-neon_bg focus:ring-2 focus:ring-neon_bg/50 transition duration-300"></textarea>
                    </div>
            ...
            <div className="text-center mb-12">
                <div className="relative inline-block group">
                    ...
                    <a href="https://drive.google.com/file/d/1CcOHExP3SqesvjnIEBJIHp5u7OpgLm6d/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="relative inline-flex items-center px-8 py-3 bg-[#1A1A1A] text-white border border-neon_bg rounded-xl space-x-2 hover:bg-neon_bg/10 transition-all duration-300" >
