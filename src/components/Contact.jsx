...
const Contact = () => {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/jeffrinjojo/',
      icon: <FaLinkedin className="text-5xl" />,
      color: 'text-[#FF3072]'
    },
    {
      name: 'GitHub',
      url: 'https://github.com/Jeffrin2005',
      icon: <FaGithub className="text-5xl" />,
      color: 'text-[#FF3072]'
    },
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/jeffrinjojo/',
  ...
  return (
    <div className='w-full py-16 px-4 bg-[#0A0A0A] relative overflow-hidden'>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 
                    w-[600px] h-[600px] bg-[#FF3072] opacity-[0.15] blur-[120px] rounded-full
                    animate-pulse" />
      
      <div className='max-w-[1240px] mx-auto relative'>
        <div className='text-center mb-12'>
          <h2 className='text-4xl font-bold text-[#FF3072] mb-2 
                       drop-shadow-[0_0_12px_rgba(255,48,114,0.6)]
                       animate-glow'>
            Let's Connect
          </h2>
          <p className='text-gray-400 text-lg relative inline-block
                      after:content-[""] after:absolute after:bottom-0 after:left-0 
                      after:w-full after:h-[1px] after:bg-[#FF3072]
        ...
        <div className="relative group mb-12"
             onMouseEnter={() => setHoverStates(prev => ({...prev, form: true}))}
             onMouseLeave={() => setHoverStates(prev => ({...prev, form: false}))}>
          {/* Multi-layered neon border effect */}
          <div className="absolute -inset-0.5 bg-[#FF3072] opacity-75 blur-sm rounded-xl
                         group-hover:opacity-100 transition-opacity duration-300" />
          <div className="absolute -inset-1 bg-[#FF3072] opacity-50 blur-md rounded-xl
                         group-hover:opacity-75 transition-opacity duration-300" />
          <div className="absolute -inset-1.5 bg-[#FF3072] opacity-25 blur-lg rounded-xl
          ...
          <div className="relative bg-[#1A1A1A] p-8 rounded-xl border border-[#FF3072]">
            <form className="space-y-6">
              <div className="space-y-4">
                {['Your Name', 'Your Email'].map((placeholder, index) => (
                  <input
                    ...
                    className="w-full p-3 rounded-lg bg-[#252525] text-white 
                             border border-[#FF3072]/30 relative
                             focus:border-[#FF3072] focus:ring-2 focus:ring-[#FF3072]/50 
                             shadow-[0_0_10px_rgba(255,48,114,0.2)]
                             focus:shadow-[0_0_20px_rgba(255,48,114,0.4)]
              ...
              <button
                type="submit"
                className="w-full bg-[#FF3072] text-white py-3 px-6 rounded-lg font-medium"
              >
                Send Message
              </button>
            </form>
        ...
        <div className="flex justify-center space-x-12">
          {socialLinks.map((social, index) => (
            ...
            >
              <div className="absolute -inset-2 bg-[#FF3072] opacity-25 blur-md rounded-full
                           group-hover:opacity-75 transition-all duration-300" />
              <div className={`${social.color} relative transform transition-all duration-300
                            group-hover:scale-110 group-hover:drop-shadow-[0_0_8px_rgba(255,48,114,0.8)]`}>
                {social.icon}
              </div>
            </a>
          ))}
